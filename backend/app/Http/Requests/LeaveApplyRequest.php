    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'leave_type_id' => ['required', 'integer',
                Rule::exists('leave_types', 'id')->where('company_id', $companyId)->whereNull('deleted_at')],
            ...
            'document_id' => ['nullable', 'integer',
                Rule::exists('employee_documents', 'id')->where('company_id', $companyId)->whereNull('deleted_at')],
        ];
    }
